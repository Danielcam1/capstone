...
<?php $__env->startSection('title', 'Fill Up Form'); ?>

<?php $__env->startSection('content'); ?>
<div class="container bg-light mb-5">
    <div class="card p-4">
        <form method="POST" action="<?php echo e(route('submit.fillup')); ?>">
            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Ramos Familla\FinalRequirements\resources\views/fillup.blade.php ENDPATH**/ ?>